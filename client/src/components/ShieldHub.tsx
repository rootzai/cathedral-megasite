...
export default function ShieldHub() {
  ...
  return (
    <div className="relative w-full max-w-6xl mx-auto py-24 px-8 bg-[#050505] border border-red-900/20 shadow-[0_0_100px_rgba(0,0,0,1)] overflow-hidden">
      <div className="text-center mb-16 relative z-10">
        <p className="font-mono text-[10px] tracking-[0.5em] text-[#8b1a1a] uppercase mb-4">Forensic Architecture // Systemic Shield</p>
        <h2 className="font-serif text-5xl md:text-6xl tracking-tight text-white mb-6 uppercase" style={{ fontFamily: "'Playfair Display', serif" }}>
          The Shield of Sodom Hall
        </h2>
        <div className="w-32 h-1 bg-[#8b1a1a] mx-auto mb-6 shadow-[0_0_15px_#8b1a1a]" />
        <p className="text-zinc-500 font-serif text-lg italic max-w-2xl mx-auto leading-relaxed">
          "The Architecture of Protection is built in blood and ink. To find the source, one must penetrate the five rings of silence."
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center relative z-10">
        ...
        <div className="lg:col-span-7 relative aspect-square flex items-center justify-center">
          ...
          >
            ...
            <span className="font-mono text-[8px] font-black text-white uppercase tracking-tighter">PERPETRATORS</span>
            
            {/* Popover on hover? No, just keep it lethal */}
            <div className="absolute -top-12 opacity-0 group-hover:opacity-100 transition-opacity bg-black border border-red-600 p-2 text-[8px] text-red-400 w-32 text-center pointer-events-none">
              THE CORE SEED OF COMPLICITY
            </div>
          </motion.div>

          {/* BREACH POINT ARROW */}
          <div className="absolute bottom-[20%] left-[15%] flex flex-col items-center z-40 transform -rotate-[35deg]">
             <div className="bg-red-600/20 border border-red-600 p-2 rounded-full animate-pulse">
                <AlertCircle className="w-6 h-6 text-red-600" />
             </div>
             <div className="w-1 h-24 bg-gradient-to-t from-red-600 to-transparent" />
             <span className="absolute -bottom-8 font-mono text-[8px] text-red-500 rotate-[35deg] whitespace-nowrap">BREACH POINT // AG OFFICE</span>
          </div>
        ...
        <div className="lg:col-span-5 flex flex-col gap-6">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="bg-[#0a0a0c] border border-white/5 p-10 min-h-[450px] relative overflow-hidden"
            >
              ...
              {hoveredRing ? (
                <div className="space-y-8">
                  <div>
                    <div className="flex items-center gap-3 mb-2">
                       ...
                       <span className="font-mono text-[10px] text-[#8b1a1a] uppercase tracking-[0.4em]">Section Header // Ring {hoveredRing}</span>
                    </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-6 border-t border-zinc-800">
                       <h4 className="font-mono text-[10px] text-zinc-600 uppercase mb-4 tracking-widest">Key Targets within Ring:</h4>
                  ...
                  <Link href={RINGS.find(r => r.id === hoveredRing)?.route || '#'}>
                    <motion.button
                      whileHover={{ x: 10 }}
                      className="group flex items-center gap-4 text-[#d4af37] uppercase font-mono text-xs tracking-[0.3em] mt-8 bg-zinc-900/50 px-6 py-4 border border-[#d4af37]/20 hover:bg-[#d4af37]/10 transition-all"
                    >
                ...
                <div className="h-full flex flex-col items-center justify-center text-center opacity-40">
                  <Shield className="w-20 h-20 text-[#8b1a1a] mb-8 animate-pulse" />
                  ...
                  <p className="font-mono text-[10px] text-zinc-600 uppercase tracking-widest leading-relaxed">
                    Hover a ring to reveal the institutional barrier.<br />
                    Authenticated Forensic Stream [ES-99-B] active.
                  </p>
                </div>
              )}
            </motion.div>
