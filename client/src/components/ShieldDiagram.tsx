...
const NODES: NodeDef[] = [
  // Ring 5
  { id: "kelli-nyre",     label: "Kelli Nyre",               angle: 35,  ring: 5, destination: "/expose/nyre-dismissal", destinationType: 'internal' },
  { id: "national-media", label: "NATIONAL MEDIA",           angle: 60,  ring: 5, isMedia: true, destination: "/opinion", destinationType: 'internal' },
  { id: "lara-mck",       label: "Lara McKeever",            sublabel: "and Sisters", angle: 82, ring: 5, destination: "/ledger/mccarrick/survivors", destinationType: 'internal' },
  ...
  { id: "congress",       label: "Congress",                 angle: 132, ring: 5, destination: "/breach", destinationType: 'internal' },
  { id: "victims-bottom", label: "VICTIMS",                  angle: 178, ring: 5, isVictim: true, destination: "/ledger/mccarrick/survivors", destinationType: 'internal' },
  { id: "victims-law",    label: "Victims Law Firms",        angle: 205, ring: 5, destination: "/ledger#lawyers", destinationType: 'internal' },
  ...
  // Ring 4
  { id: "shu-univ",       label: "Seton Hall",      sublabel: "University",          angle: 50,  ring: 4, destination: "/ledger", destinationType: 'internal' },
  ...
  { id: 'myers', label: 'John Myers', ring: 4, angle: 10, isRingleader: true, destination: "/ledger/myers", destinationType: 'internal' },
  { id: 'serratelli', label: 'Arthur Serratelli', ring: 4, angle: 45, isRingleader: true, destination: "/ledger/serratelli", destinationType: 'internal' },
  ...
  { id: 'critchley', label: 'Michael Critchley', ring: 3, angle: -10, isRingleader: true, destination: "/ledger/critchley", destinationType: 'internal' },
  ...
  { id: "lowenstein",     label: "Lowenstein",                                  angle: 300, ring: 3, destination: "/ledger#lawyers", destinationType: 'internal' },
  { id: "troutman",        label: "Troutman Pepper",                             angle: 318, ring: 3, destination: "/ledger#lawyers", destinationType: 'internal' },
  ...
  // Ring 2
  { id: "shu-legal",      label: "SHU Legal Firms",                             angle: 36,  ring: 2, destination: "/ledger#lawyers", destinationType: 'internal' },
  { id: "christie-ag",    label: "Christie's",     sublabel: "Legal Mafia",     angle: 75, ring: 2, destination: "/ledger#lawyers", destinationType: 'internal' },
  { id: "canon-law",      label: "Canon Law",      sublabel: "Tribunal",        angle: 235, ring: 2, destination: "/documents", destinationType: 'internal' },
  { id: "secret-archives-legal", label: "Archdiocese", sublabel: "Legal Counsel", angle: 300, ring: 2, destination: "/ledger#lawyers", destinationType: 'internal' },
];
...
const CORE_NAMES: Record<string, string> = {
  ...
  "Cardinal Joseph Tobin": "/ledger/tobin",
  "Chris Christie": "/ledger#christopher-j-christie",
  "Michael Critchley": "/ledger/critchley",
  "John J. Myers": "/ledger/myers",
  "Arthur J. Serratelli": "/ledger/serratelli",
