    ...
    return (
        <div className="bg-[#111116] border-b border-[#1a1a22] overflow-x-auto whitespace-nowrap scrollbar-hide">
            <div className="max-w-7xl mx-auto px-6 flex items-center gap-8 py-2">
                <span className="text-xs font-bold text-[#555] uppercase tracking-[0.2em] pr-4 border-r border-[#1a1a22]">
                    SELECT RING
                </span>
                {RINGS.map((ring) => (
                    <Link
                        ...
                        href={ring.route}
                        className={`
              text-xs font-bold uppercase tracking-[0.2em] transition-all py-1
              ${location === ring.route
