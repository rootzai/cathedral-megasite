        ...
        <section className="py-24 bg-gray-900 border-y border-red-900/10 text-white">
            <div className="container mx-auto max-w-6xl px-4">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <a href="#act-ix" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group shadow-lg text-white">
                    ...
                    <a href="#act-viii" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group shadow-lg text-white">
                    ...
                    <a href="#act-vi" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group text-white">
                    ...
                    <a href="#act-v" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group text-white">
                    ...
                    <a href="#act-iv" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group text-white">
                    ...
                    <a href="#act-iii" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group text-white">
                    ...
                    <a href="#act-ii" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group text-white">
                    ...
                    <a href="#act-i" className="block p-6 bg-black border border-gray-800 hover:border-red-600 transition-all rounded-lg group text-center text-white">
