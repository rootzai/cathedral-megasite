...
import { AlertTriangle, Scale, Activity, MapPin, ExternalLink, Filter, Eye } from "lucide-react";
...
export default function ActiveCaseDossiers() {
  ...
  const filteredNarratives = selectedState 
    ? Object.entries(bankruptcyNarratives).filter(([_, data]) => {
    ...
    : Object.entries(bankruptcyNarratives);
            ...
            <TabsList className="flex flex-col h-auto w-full bg-transparent space-y-2 p-0">
              ...
              >
                <div className="text-left flex items-center gap-2">
                  <div className="font-semibold">View Full List ({Object.keys(bankruptcyNarratives).length})</div>
