          ...
          <Dialog key={meme.src}>
            <DialogTrigger asChild>
              <div className="group relative cursor-pointer overflow-hidden rounded-lg border border-border bg-card transition-all hover:border-destructive/50 hover:shadow-lg hover:shadow-destructive/10">
                ...
                <div className="absolute inset-0 bg-white/60 opacity-0 transition-opacity duration-300 group-hover:opacity-100 flex items-center justify-center">
                  <p className="font-heading text-xl text-zinc-900">{meme.title}</p>
                </div>
              </div>
            </DialogTrigger>
            <DialogContent className="max-w-4xl bg-white border-destructive/20">
