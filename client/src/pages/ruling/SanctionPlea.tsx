      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <Card className="bg-card border-border hover:border-destructive/50 transition-all duration-500">
          <CardHeader>
            ...
            <CardTitle className="font-heading text-2xl text-foreground">Hiding the Latham Report</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="font-body text-foreground border-l-2 border-destructive pl-4 italic">
        ...
        <Card className="bg-card border-border hover:border-destructive/50 transition-all duration-500">
          <CardHeader>
            ...
            <CardTitle className="font-heading text-2xl text-foreground">Suing Joe Nyre for "Leaking" It</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
            <p className="font-body text-muted-foreground">
