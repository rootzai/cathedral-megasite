      ...
      <div className="lg:col-span-8 space-y-8">
        ...
        <div className="border-2 border-destructive/30 bg-destructive/5 p-8 my-12 relative overflow-hidden group">
          ...
          <div className="space-y-4 font-body text-lg leading-relaxed text-foreground/80">
            <p>
              On February 13, 2026, the investigation was formally escalated to <strong>New Jersey Chief Justice Stuart Rabner</strong>. The submitted dossier contains 19 verified exhibits documenting what is now described as a "Closed Loop" of institutional corruption.
            </p>
            <p>
              The escalation demands the appointment of a <strong>Special Prosecutor</strong> to investigate official misconduct and the referral of the judiciary's handling of these cases to the ACJC.
            </p>
          </div>
          <div className="mt-8">
            <Link href="/expose">
              <Button variant="link" className="text-destructive hover:text-destructive/80 p-0 h-auto font-mono text-xs uppercase tracking-widest gap-2">
                Read The Architecture of Silence <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
          </div>
        </div>
