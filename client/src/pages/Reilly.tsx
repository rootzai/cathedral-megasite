...
import { AlertTriangle, ArrowRight, Image as ImageIcon, Siren } from "lucide-react";
        ...
        <section className="relative border-b border-border pb-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <ImageModal 
              ...
              className="aspect-[4/5] shadow-2xl shadow-destructive/20 border-destructive/50"
              caption="Msgr. Joseph Reilly: President, Seton Hall University"
            />
          </div>
        </section>
            ...
            <div className="lg:col-span-2 space-y-8">
              <div className="bg-card border border-border p-8 rounded-lg space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-6">
                    <ImageModal 
                      src="/images/reilly-beach-house-dark.png" 
                      alt="Reilly's Beach House Admission" 
                      className="aspect-video w-full shadow-xl border-destructive/20"
                      caption="Reilly's admission: 'I went to the McCarrick beach house once...'"
                    />
                  </div>
                </div>
