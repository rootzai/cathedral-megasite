...
export default function Warnings() {
  return (<div className="space-y-8 animate-in fade-in duration-1000 slide-in-from-bottom-4">
    <div className="relative overflow-hidden rounded-sm -mx-4 mb-4">
      <img src="/assets/images/tobin-silence.png" alt="" className="w-full h-48 md:h-64 object-cover opacity-[0.08] select-none pointer-events-none" />
      <div className="absolute inset-0 bg-gradient-to-t from-background via-background/80 to-transparent" />
      {/* ⚠ — The Warning Room. They knew. They all knew */}
    ...
    <div className="space-y-12 mt-12">
      ...
      <div className="relative pl-8 border-l border-border">
        ...
        <div className="bg-[#f5f0e8] text-zinc-900 p-6 font-mono text-sm leading-loose rounded-sm shadow-lg">
          <p className="mb-4 uppercase text-destructive font-bold border-b border-zinc-300 pb-2">CONFIDENTIAL MEMO: O'CONNOR TO NUNCIO</p>
          <p>
