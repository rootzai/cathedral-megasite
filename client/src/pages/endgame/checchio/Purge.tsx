      ...
      <div className="relative border-l-2 border-destructive/30 ml-4 space-y-12 pb-12">
        ...
        <div className="relative pl-8">
          ...
          <p className="text-muted-foreground">
            Latham & Watkins investigators present their verbal findings to the Board of Regents. They identify 12 priests and bishops, including Msgr. Reilly, for removal due to abuse allegations or failure to report. Notably, investigator Mark Gibbons named Cardinal Tobin as having refused to sit down with investigators.
          </p>
        </div>
