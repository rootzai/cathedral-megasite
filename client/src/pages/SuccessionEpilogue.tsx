...
export default function SuccessionEpilogue() {
    return (
        <div className="page-enter max-w-5xl mx-auto px-6 py-12 space-y-20 relative">
            <img src="/assets/cathedral/cathedral_rose_window.jpg" alt="" className="fixed inset-0 w-full h-full object-cover select-none pointer-events-none brightness-[0.08] saturate-50" />
