    ...
    <div className="humpty-container">
      ...
      <div className="book">
        ...
        <div className="narrative">
          ...
          <div id="egg-8" className={`egg-panel ${isOpen(8) ? 'open' : ''}`}>
            ...
            <div className="egg-panel-inner">
              ...
              <div className="egg-quote">
                ...
                <span className="egg-quote-attr">— Litigation as a Weapon, submitted to Congress, April 1, 2026</span>
              </div>
            </div>
          </div>
          ...
          <div className="forensic">
            The throne room is Orange County Superior Court, Department C23, Santa Ana. The hearing date is May 28, 2026. The suitors are SHU's lawyers — Troutman Pepper, armed with the Scrivo declaration; a California deposition subpoena; and the argument that Dei Journo is not a journalist. The King is the court itself. The Princess — the thing being sought — is Dei Journo's testimony, his sources, his documents.
          </div>
