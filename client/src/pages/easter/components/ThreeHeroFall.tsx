...
export default function ThreeHeroFall() {
    return (
        <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100vh', zIndex: 0, pointerEvents: 'none', background: 'radial-gradient(circle at center, #111114 0%, #050505 100%)' }}>
