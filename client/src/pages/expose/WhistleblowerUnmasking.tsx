/* ============================================================
   THE ARCHITECTURE OF SILENCE — The Whistleblower Unmasking
  ...
  return (
    <div className="page-enter max-w-4xl mx-auto px-6 py-10">
      ...
      <div className="space-y-5 text-base leading-relaxed mb-8" style={{ color: "var(--ink-mid)", fontFamily: "'Lora', serif" }}>
        ...
        <p>
          The target of the subpoena was <strong style={{ color: "var(--ink)" }}>a California-based journalist</strong> —
          a former newspaper publisher and whistleblower. The use of a
        ...
        <table className="forensic-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Bergen County, NJ</td>
              <td>Whistleblower identified as account holder</td>
            </tr>
            <tr>
              <td style={{ color: "var(--gold)", fontWeight: 600, whiteSpace: "nowrap" }}>Nov 20, 2025</td>
              <td style={{ color: "var(--ink)" }}>Orange County civil subpoena for deposition</td>
            ...
            <tr>
              ...
              <td style={{ color: "var(--ink)" }}>52-page deposition package sent to journalist</td>
      ...
      <div className="space-y-4 text-base leading-relaxed mb-8" style={{ color: "var(--ink-mid)", fontFamily: "'Lora', serif" }}>
        ...
        <p>
          ...
          both protect journalists from compelled disclosure of sources. The whistleblower has invoked both statutes.
          The university's counter-argument — that the source is not a "journalist" because the account was
      ...
      <div className="finding-box mb-8">
        ...
        <p className="text-sm leading-relaxed" style={{ color: "var(--ink-mid)", fontFamily: "'Lora', serif" }}>
          ...
          institutional response to the warnings sent to university regents. The message was
      ...
      <div className="evidence-box">
        ...
        <p className="text-sm leading-relaxed" style={{ color: "var(--ink-mid)", fontFamily: "'Lora', serif" }}>
          ...
          The university's attorneys then sent the journalist a 52-page deposition package in January 2026 —
          ...
          from the litigation, using the legal system as a weapon. This campaign is the clearest
