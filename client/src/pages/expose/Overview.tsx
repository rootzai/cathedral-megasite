...
const sections = [
  {
    ...
    desc: "The 1980s Newark seminary and the earliest documented warnings about McCarrick's predatory 'nephews' network.",
    color: "var(--blood)",
  },
  {
    path: "/origin/network",
  ...
  {
    path: "/coverup/epstein",
    section: "VI",
    title: "The Epstein Nexus",
    desc: "The lead investigator of the seminary probe was in intimate contact with Jeffrey Epstein while conducting it.",
    color: "var(--blood)",
  },
  {
    ...
    desc: "A criminal grand jury subpoena to Google, weaponizing prosecutorial power to silence a civil whistleblower.",
    color: "var(--blood)",
  },
];
