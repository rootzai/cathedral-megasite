...
<div className="modal-overlay" id="modal-mcphee" onClick={(e) => { if (e.target.id === 'modal-mcphee') closeModal('modal-mcphee'); }}>
  <div className="modal">
    ...
    <div className="modal-body">
      ...
      <p>McPhee co-authored the 2018 Ropes &amp; Gray report on USA Gymnastics and the U.S. Olympic Committee's handling of the Larry Nassar abuse scandal. That report — "Nassar Report: A Failure to Protect" — is the most consequential institutional accountability investigation in American sports history. It documented systemic failures across USA Gymnastics, the USOC, and Michigan State University. It led to the resignation of multiple executives and the restructuring of USA Gymnastics.</p>
