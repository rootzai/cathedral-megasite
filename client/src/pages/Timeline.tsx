...
const timelineEvents = [
  ...
  },
  {
	    ...
	    type: "purge",
	    icon: UserMinus,
      image: "/images/tobin-memory-wipe.png",
      imageCaption: "Cardinal Tobin's 'Men in Black' Memory Wipe"
	  },
  {
    year: "2024",
    title: "The Promotion",
      ...
      <div className="space-y-16 animate-in fade-in duration-1000">
        ...
        >
          <ImageModal 
            ...
            className="aspect-[21/9] md:aspect-[3/1] mb-8"
            caption="The Erasure of Time"
          />
                  ...
                  <Card className={`bg-card border-border hover:border-destructive/50 transition-colors duration-300 ${
                    ...
                    <CardHeader>
                      ...
                      <CardTitle className="font-heading text-xl flex items-center gap-2">
	                    ...
	                    <CardContent>
	                      <p className="font-body text-sm text-muted-foreground mb-4">{event.description}</p>
                        {/* @ts-ignore */}
                        {event.image && (
                          <ImageModal 
                            // @ts-ignore
                            src={event.image} 
                            alt={event.title} 
                            className="aspect-video w-full shadow-sm border-destructive/20"
                            // @ts-ignore
