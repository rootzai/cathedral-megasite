    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black text-white font-mono cursor-none select-none">
            <div className="text-center space-y-4 animate-pulse">
                <p className="text-red-600 text-sm tracking-[0.5em] uppercase font-bold">Redirect</p>
                <h1 className="text-2xl md:text-4xl tracking-[0.2em] uppercase">Page not found.</h1>
                <p className="text-zinc-500 text-xs tracking-widest mt-8">Redirecting to homepage...</p>
            </div>
