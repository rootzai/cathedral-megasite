...
export const KEY_DATES = [
  ...
  { date: "2019", event: "LaSala Task Force reviews Latham Report, recommends Msgr. Reilly's removal — recommendations are ignored by the Board" },
  { date: "2023", event: "Dr. Joseph Nyre departs as Seton Hall president" },
  { date: "Feb 5, 2024", event: "Dr. Joseph Nyre and Kelli Nyre file lawsuit against Seton Hall, D'Alessandro, Lucciola, Masherelli, Collins, and Cerny (Nyre v. Seton Hall) — alleging retaliation, CEPA violations, and sexual harassment" },
  { date: "2024", event: "Board of Regents elects Msgr. Joseph Reilly as Seton Hall president despite Latham findings — knowing he was unfit to serve" },
  ...
  { date: "Nov 2025", event: "Court orders release of Latham Report; Scrivo blocks Nyre from cooperating again" },
  ...
  leadership: [
    {
      ...
      note: "Named in Gibbons Report. Failed to appear before investigators. Hired Ropes & Gray in Feb 2025.",
    },
  ],
  exOfficio: [
    {
  ...
  exOfficio: [
    {
      ...
      tenure: "2017–Present",
      badges: ["latham", "tobin", "clergy"],
      note: "Named in Gibbons Report. Failed to appear before investigators.",
    },
    {
      name: "Msgr. Joseph R. Reilly",
      role: "University President",
