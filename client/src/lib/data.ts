...
export const KEY_DATES = [
  ...
  { date: "June 10, 2024", event: "Perry Law Report is unsealed and forward to the accused man, Kevin Marino whose personal counse, former NJ AG Chris Porrinopromtply leaks it to the NYT." },
  { date: "June 11, 2024", event: "Article in NYT. <a href='https://www.nytimes.com/2024/06/11/nyregion/seton-hall-sexual-assault-nyre-marino.html' target='_blank' style='color:#b89947;text-decoration:underline;'>Read the article</a>" },
