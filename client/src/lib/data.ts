...
export const boardOfRegents: BoardSection = {
  ...
  members: [
    { name: "Mary Pat Christie", role: "Regent", tenure: "2022–2025", badges: ["latham", "reilly", "christie", "resigned"], note: "Wife of Gov. Chris Christie. Resigned July 2025 amid 'Latham Archive' unsealing." },
    { name: "Ryan K. Duffy", role: "Regent", tenure: "Appointed 2015", badges: ["latham", "reilly"] },
    { name: "Bonnie Evans", role: "Regent", tenure: "Appointed 2022", badges: ["latham", "reilly"] },
    { name: "Brian Fitzpatrick", role: "Regent", tenure: "Appointed 2022", badges: ["latham", "reilly"] },
    { name: "David L. Flood", role: "Regent", tenure: "Appointed 2025", badges: ["latham"] },
    ...
    { name: "Joseph J. Hughes", role: "Regent", tenure: "Appointed 2023", badges: ["latham", "reilly"] },
    { name: "Alan Kirshenbaum", role: "Regent", tenure: "Appointed 2025", badges: ["latham"] },
    ...
    { name: "Michael J. Lucciola", role: "Regent", tenure: "Active", badges: ["latham", "reilly", "nyre"], note: "Named defendant in Nyre v. Seton Hall (2024)." },
    ...
    { name: "Alisa Coren Norris", role: "Regent", tenure: "Appointed 2023", badges: ["latham", "reilly"] },
    { name: "Dr. Amy Novak", role: "Regent", tenure: "Active", badges: ["latham", "reilly"] },
    { name: "James O'Brien", role: "Regent", tenure: "Appointed 2015", badges: ["latham", "reilly"] },
    { name: "Jeffrey Pagano", role: "Regent", tenure: "Active", badges: ["latham", "reilly"] },
    ...
    { name: "Thomas L. Tran", role: "Regent", tenure: "Appointed 2023", badges: ["latham", "reilly"] },
    { name: "Paul Tyahla", role: "Regent", tenure: "Active", badges: ["latham", "reilly"] },
    { name: "Stephen G. Waldis", role: "Regent", tenure: "Active", badges: ["latham", "reilly"] },
    { name: "Patrick Walsh", role: "Regent", tenure: "Appointed 2023", badges: ["latham", "reilly"] },
