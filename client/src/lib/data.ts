...
export const KEY_DATES = [
  ...
  { date: "Aug 1, 2019", event: "Dr. Joseph Nyre starts as President of Seton Hall University" },
  ...
  { date: "Late 2019", event: "LaSala Task Force reviews Latham Report, recommends Msgr. Reilly's removal — recommendations are ignored by the Board. After the LaSala task force, Kevin Marino takes over as Chairman of Regents." },
  { date: "May 2023", event: "Kevin Marino instructs the erasure of Title IX abuse logbook entries that accuse him of abusing 4 people citing multiple incidents." },
  { date: "2023", event: "Dr. Joseph Nyre departs as Seton Hall president" },
  { date: "Dec 2023", event: "Kevin Marino resigns from board as part of the settlement agreement with one of his alleged victims." },
  { date: "March 2024", event: "The Title IX abuse logbook entries are restored." },
  { date: "March 2024", event: "Dr. Joseph Nyre and Kelli Nyre file lawsuit against Seton Hall, D'Alessandro, Lucciola, Masherelli, Collins, and Cerny in NJ Court — alleging retaliation, CEPA violations, and sexual harassment" },
  { date: "June 1, 2024", event: "Msgr. Joseph Reilly's first day as Seton Hall President" },
  ...
  { date: "June 11, 2024", event: "Article in NYT detailing the Perry Law Report and Kevin Marino's involvement. <a href='https://www.nytimes.com/2024/06/11/nyregion/seton-hall-sexual-assault-nyre-marino.html' target='_blank' style='color:#b89947;text-decoration:underline;'>Read the article</a>" },
  { date: "Sept 2024", event: "Resignation of Regent Kevin Flood" },
  { date: "Nov 3, 2024", event: "Investiture of Msgr. Joseph Reilly" },
  { date: "Dec 21, 2024", event: "Politico reveals existence of suppressed Latham Report — the cover-up begins to unravel" },
  { date: "Jan 2025", event: "Judge Avion Benjamin first reads about the Politico story and scolds Seton Hall and Scrivo." },
  { date: "Early 2025", event: "Judge Avion Benjamin orders the delivery of the 24,000 pages to her in camera review." },
  { date: "Feb 2025", event: "Prior to R&G, Gov. Phil Murphy calls for transparency and the release of the Latham Report. Then Congresswoman Sherrill (SHU is in her district) also came out for release." },
  ...
  { date: "Nov 2025", event: "Judge Avion Benjamin rules that the docs would be released to the attorneys. Court orders release of Latham Report; Scrivo blocks Nyre from cooperating again" },
